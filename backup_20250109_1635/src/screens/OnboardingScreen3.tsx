...
// Экран 3 - Третий экран онбординга
export default function OnboardingScreen3({ onContinue, onSkip, currentStep = 3 }: OnboardingScreen3Props) {
  // Элементы экрана (только элементы 21-24):
  ...
  return (
    <ImageBackground 
      source={require('../../assets/images/onboarding-screen3-background.png')} 
    ...
    >
      ...
      <View style={styles.textContainer}>
        <Text style={styles.title}>
          Диагностика, основанная{'\n'}на реальных кейсах
        </Text>
        <Text style={styles.subtitle}>
          Методология Pelby разработана на основе сотен проектов и провереных решений.
        </Text>
      </View>
      
      {/* 22. Кнопка Начать и точки индикатора */}
      <View style={styles.buttonContainer}>
        <AnimatedPressable
          onPress={onContinue}
          style={styles.continueButton}
        >
          <Text style={styles.continueButtonText}>Начать</Text>
        </AnimatedPressable>
